    ...
    ** \par Examples include:
    ** \code
    **  AAA (AAA COSMETIC SUPPLY) ~ C006585
    **  ADVANCE (ADVANCE PROTOTYPES INC) ~ C006767
    **  ALB (ALFRED LARGE BOATS) ~ C000005
    **  ALF (AMWARE COMPANY INC) ~ C002885
    **  DATA (DATA TRANSFER CABLE INC) ~ C002247
    **  DEIPLAN (DEIPLAN-TRAVELOCO) ~ C005227
    **  DEKA (DEKA LIBRARY CO) ~ C001319
    **  DSI (DSI INDIRECT) ~ C006488
    **  DYNE (DYNE ROUNDABOUT) ~ C006166
    **  DYNE IND (DYNE INDISCRETE) ~ C005418
    **  SOLO (SOLO SINGERS) ~ C002094
    **  SOP (SOPLANTING INC) ~ C000030
    **  STAY (STAY AWAY INC) ~ C002876
    **  \-v-/ \-----v-----/  \----v---/
    **    |         |             |
    **    |         |             +------------ clientIdPart()
    **    |         +-------------------------- name()
    ...
    ** \par Examples include:
    ** \code
    **  approot/customer/A/AAA (AAA COSMETIC SUPPLY) ~ C006585
    **  approot/customer/A/ADVANCE (ADVANCE PROTOTYPES INC) ~ C006767
    **  approot/customer/A/ALB (ALFRED LARGE BOATS) ~ C000005
    **  approot/customer/A/ALF (AMWARE COMPANY INC) ~ C002885
    **  approot/customer/D/DATA (DATA TRANSFER CABLE INC) ~ C002247
    **  approot/customer/D/DEIROSSI (DEIPLAN-TRAVELOCO) ~ C005227
    **  approot/customer/D/DEKA (DEKA LIBRARY CO) ~ C001319
    **  approot/customer/D/DSI (DSI INDIRECT) ~ C006488
    **  approot/customer/D/DYNE (DYNE ROUNDABOUT) ~ C006166
    **  approot/customer/D/DYNE IND (DYNE INDISCRETE) ~ C005418
    **  approot/customer/S/SOLO (SOLO SINGERS) ~ C002094
    **  approot/customer/S/SOP (SOPLANTING INC) ~ C000030
    **  approot/customer/S/STAY (STAY AWAY INC) ~ C002876
    **  \-------v------/ v \-v-/ \-----v-----/  \----v---/
    **          |        |   |         |             |
    **          |        |   |         |             +------------ clientIdPart()
    **          |        |   |         +-------------------------- name()
