...
#include "FieldDefLookupWidget.h"

Wt::Signal<> & Wtx::Dbo::FieldDefLookupWidget::TableLineEdit::pickered()
{
  return m_pickered;
}
...
class TabLinEdi
: public Wtx::Dbo::FieldDefLookupWidget::TableLineEdit
//: public Wt::WInPlaceEdit
{
  public:
    ...
    (
     int sid,
     Wtx::Dbo::FieldDefLookupWidget * fieldDef,
     Wtx::Dbo::Session & s
    )
    : m_session  ( s        ),
      m_sourceID ( sid      ),
...
//        << "\n valueText:" << lineEdit()-> valueText()
    ...
    Wtx::Dbo::FieldDefLookupWidget * fieldDef() { return m_fieldDef; }
    Wtx::Dbo::FieldDefLookupBase::Provider * provider() { return fieldDef()-> provider(); }

    Wtx::Dbo::FieldDefLookupWidget * m_fieldDef = nullptr;
    bool m_loaded = false;
    std::string m_field;
    std::string m_table;
    int m_sourceID = -1;
...
Wtx::Dbo::FieldDefLookupWidget::FieldDefLookupWidget
(
 TableDef & td,
 const char * fn,
 int w,
...
std::unique_ptr<Wt::WWidget> Wtx::Dbo::FieldDefLookupWidget::createEditWidget( int sid, Wtx::Dbo::Session & session ) const
{
//  std::cout << __FILE__ << ":" << __LINE__
//    << "\n sid: " << sid
//    << std::endl
...
//  auto retVal = std::make_unique< TableLineEdit >( sid, getLookupModel, getTableView, session );
  auto retVal = std::make_unique< TabLinEdi >( sid, const_cast<Wtx::Dbo::FieldDefLookupWidget*>(this), session );
