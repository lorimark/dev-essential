...
#ifndef __WTX_DBO_FIELDVAR_H_234e0174_6b7d_11e8_b503_fb1ef3651ec0__
#define __WTX_DBO_FIELDVAR_H_234e0174_6b7d_11e8_b503_fb1ef3651ec0__
...
: public Field<std::string>
{
  public:
    ...
    std::string value( const std::string & fieldName ) const;

    void setValue( const std::string & value );

    void setValue( const std::string & field, const std::string & value );
    void setValue( const std::string & field, int value );
